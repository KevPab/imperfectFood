...
<body>
    <?php  
       echo '<script>alert("El nombre que ingreso no esta disponible")</script>';
    ?>
  ...
  <section class="fondoVendedores">
                        ...
                        <div class="col-lg-5">
                          ...
                          <div class="col">
                              <label for="NombreNegocio" class="form-label">Nombre de Negocio:</label>
                               <input type="text" name="NombreNegocio" id="NombreNegocio"class="form-control" pattern = "^\S[A-Z|a-z|0-9|`|Ñ|ñ|áéíóú|&|.|\s|!|\x22|-|\-|'|,]{1,20}\S$" required>
                          ...
                          <div class="col">
                             ...
                             <input type="text" name="Email" id="Email" class="form-control" placeholder="example@gmail.com" pattern = "^[a-z|A-Z|0-9]+@[a-z]+\.[a-z]{1,3}$" placeholder = "ejemplo@gmail.com" required>
                          ...
                          <div class="row">
                            ...
                            <div class="col">
                                 <input name="password" type="password" class="form-control" id="password" aria-label="password" aria-describedby="basic-addon1" pattern = "^[A-Z|a-z|0-9|&|$|Ñ|ñ|@|-|%|*|#|,|_|.|;|+|/]{6,14}$" required />
                                 <div id = "validacion3" class="invalid-feedback">
                                     La contraseña debe tener un mínimo de 6 caracteres y un máximo de 14 caracteres
                                  </div>
                            </div>
                            <div class="col-2">
                          ...
                          <div class="col">
                             ...
                             <input type="text" name="Descripcion" id="Descripcion" class = "form-control" pattern =  "^\S[A-Z|a-z|0-9|Ñ|ñ|áéíóú|.|,|\s]{30,300}\S$"> 
                          </div>
                        </div>
    ...
    <script src="javascript/validacionFormularioVendedores2.js"></script>

                    ...
                    <div class="row justify-content-center my-1" style=" margin-top: 50px; border-radius: 10px; box-shadow: 10px 10px 10px -6px black; background-color:white;">
                        ...
                        <div class="col-lg-5">
                          ...
                          <div class="col">
                             ...
                             <input type="text" name="Email" id="Email" class="form-control" placeholder="example@gmail.com"  placeholder = "ejemplo@gmail.com" pattern = "^[a-z|A-Z|0-9]+@[a-z]+\.[a-z]{1,3}$" required>
                          ...
                          <div class="row">
                            ...
                            <div class="col">
                                 ...
                                 <div id = "validacion3" class="invalid-feedback">
                                     La contraseña debe tener un mínimo de 6 caracteresy un máximo de 14 caracteres
                                  </div>
                            </div>
                            <div class="col-2">
                        ...
                        <div class="col-lg-4 align-self-center">
                             ...
                             <div style="opacity: 0;">
                               ...
                               <div id = "validacion7" class="invalid-feedback">

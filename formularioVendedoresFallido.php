                        ...
                        <div class="col-lg-5">
                          ...
                          <div class="col">
                              <label for="NombreNegocio" class="form-label">Nombre de Negocio:</label>
                               <input type="text" name="NombreNegocio" id="NombreNegocio"class="form-control" pattern = "^\S[A-Z|a-z|0-9|`|Ñ|ñ|áéíóú|&|.|\x22|\s|!|-|\-|'|,]{1,20}\S$" required>
                          ...
                          <div class="row">
                            ...
                            <div class="col">
                                 ...
                                 <div id = "validacion3" class="invalid-feedback">
                                     La contraseña debe tener un mínimo de 6 y un máximo de 14 caracteres
                                  </div>
                            </div>
                            <div class="col-2">
